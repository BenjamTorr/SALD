"""
Fine tune the FM DIFFUSION MODEL USING RIDGE REGRESSION MODEL
...
def main(cfg):
    ...
    model.fine_tune_DRAFT_prediction(loader = train_loader, loader_val = val_loader,
                        ...
                        store_path = str(Path(cfg["OUTPUT_DIR"]) / f'{cfg["RUN_NAME"]}_finetuned_fm_{type_model}_{cfg["TIME_SHORT"]}.pt'))
